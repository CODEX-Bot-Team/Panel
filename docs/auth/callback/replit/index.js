...
async function callback() {
    ...
    document.getElementById("image").setAttribute("src", "https://cdn.discordapp.com/avatars/" + Data.DiscordUser.id + "/" + Data.DiscordUser.avatar + ".png") 
